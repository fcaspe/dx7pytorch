                 ...
                 int do_control_update)
{
    ...
    //DEBUG_MESSAGE(-1,"[DEBUG] Algorithm is: %d ",voice->algorithm);
...
#define RENDER \
        for (sample = 0; sample < sample_count; sample++) { \
            /* calculate amplitude modulation amounts */ \
            i = FP_MULTIPLY(voice->amp_mod_lfo_amd_value, voice->lfo_delay_value); \
            /*DEBUG_MESSAGE(-1,"lfo_amd_value: %f lfo_delay_value %f ",voice->amp_mod_lfo_amd_value, voice->lfo_delay_value);*/ \
            /*DEBUG_MESSAGE(-1,"i1: %f ",i);*/\
            i = voice->amp_mod_env_value + \
                    FP_MULTIPLY(i + voice->amp_mod_lfo_mods_value, instance->lfo_buffer[sample]); \
            /*DEBUG_MESSAGE(-1,"i2: %f ",i);*/\
            ampmod[3] = i; \
            ampmod[2] = FP_MULTIPLY(i, AMPMOD2_CONSTANT); \
            ampmod[1] = FP_MULTIPLY(i, AMPMOD1_CONSTANT); \
            /*DEBUG_MESSAGE(-1,"\n[PH-%lu] %f %f %f %f %f %f \n",sample,voice->op[OP_1].phase,voice->op[OP_2].phase,voice->op[OP_3].phase,voice->op[OP_4].phase,voice->op[OP_5].phase,voice->op[OP_6].phase);*/\
            /*DEBUG_MESSAGE(-1,"[IN-%lu] %f %f %f %f %f %f \n",sample,voice->op[OP_1].phase_increment,voice->op[OP_2].phase_increment,voice->op[OP_3].phase_increment,voice->op[OP_4].phase_increment,voice->op[OP_5].phase_increment,voice->op[OP_6].phase_increment);*/\
            ALGORITHM; \
            /* voice->volume_value contains a scaling factor for the number of carriers */ \
            /* mix voice output into output buffer */ \
            /*DEBUG_MESSAGE(-1,"output: %f volume_value %f\n ",output, voice->volume_value);*/ \
            out[sample] += FP_TO_FLOAT(output) * voice->volume_value; \
            /*DEBUG_MESSAGE(-1,"%f ",output);*/\
            /* update runtime parameters for next sample */ \
            voice->op[OP_6].phase += voice->op[OP_6].phase_increment; \
            voice->op[OP_5].phase += voice->op[OP_5].phase_increment; \
            voice->op[OP_4].phase += voice->op[OP_4].phase_increment; \
...
#undef op_sfb
    ...
    /*DEBUG_MESSAGE(-1,"[EXIT FROM RENDER]. sample = %lu do_control_update = %d\n",sample,do_control_update);*/
    if (do_control_update) {
        ...
        /*DEBUG_MESSAGE(-1,"\n[PH--CU] %f %f %f %f %f %f \n",voice->op[OP_1].phase,voice->op[OP_2].phase,voice->op[OP_3].phase,voice->op[OP_4].phase,voice->op[OP_5].phase,voice->op[OP_6].phase);*/
        /*DEBUG_MESSAGE(-1,"[IN--CU] %f %f %f %f %f %f \n",voice->op[OP_1].phase_increment,voice->op[OP_2].phase_increment,voice->op[OP_3].phase_increment,voice->op[OP_4].phase_increment,voice->op[OP_5].phase_increment,voice->op[OP_6].phase_increment);*/
#endif /* HEXTER_USE_FLOATING_POINT */
